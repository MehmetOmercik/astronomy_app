...
export const HomeCard: FC<HomeCardProps> = ({icon, title, navigatePath}) => {
  ...
  return (
    <section 
      className='flex flex-col p-3 items-center border border-gray-500 rounded-3xl md:hover:scale-110 md:hover:bg-purple-700 transition-all duration-500 md:cursor-pointer' 
